...
|---|---|---|
| ElevenLabs voice calibration (dry-run → approval → execute → WPM publication) — own repository, adapter verb in the CLI | `src/commands/calibration-ui.ts` (adapter); package lives in [`Davidb-2107/voice-calibration`](https://github.com/Davidb-2107/voice-calibration) | [`calibration-architecture.md`](https://github.com/Davidb-2107/voice-calibration/blob/main/docs/calibration-architecture.md), [`calibration-mvp.md`](https://github.com/Davidb-2107/voice-calibration/blob/main/docs/calibration-mvp.md), [`elevenlabs-calibration-contract-inventory.md`](https://github.com/Davidb-2107/voice-calibration/blob/main/docs/elevenlabs-calibration-contract-inventory.md) |
