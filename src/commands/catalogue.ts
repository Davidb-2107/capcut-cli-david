...
export const sortedSet = (values: Iterable<string>): string[] => [...new Set(values)].sort(byCodepoint);

export function blank(id: string, today: string): CatalogueEntry {
  return {
    id,
    kinds: [],
    names: [],
...
export const ENVELOPE = "capcut-david/catalogue@1";
