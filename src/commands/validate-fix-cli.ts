...
import { hasBlockingErrors, type Report, reportExitCode, runValidate, type ValidateOpts } from "./validate.js";
import { FIXER_ORDER, type FixerName, findingsForFixer, planValidateFix } from "./validate-fix.js";
...
export function cmdValidateFix(
  ...
  // the committed result. Inert: nothing writes after this (index.ts returns the exit code).
