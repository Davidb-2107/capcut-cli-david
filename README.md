...
Le dossier `Shared/calibration-ui-mvp` contient l’application et son UI. La
source WPM autoritative reste dans `Shared/voice-calibration/voice_wpm.json`.
Les projets CapCut ou autres consommateurs utilisent ensuite les profils
publiés ; ils ne sont pas nécessaires pour lancer cet outil.
