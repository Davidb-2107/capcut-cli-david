...
La calibration vocale vit dans son propre dépôt autonome, sans lien avec ce CLI :
[voice-calibration](https://github.com/Davidb-2107/voice-calibration) (interface locale BYOK, `voice-calibration --open`).
