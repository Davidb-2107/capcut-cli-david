...
**Vérification locale (2026-09-25) :** build et tests avec gate coverage ≥80 % verts ; golden-output global : 434 captures et 116 round-trips identiques (le verbe `batch` n'y figure pas) ; tests `batch` au bord du processus et fidelity sweep : 21/21. CI 15/15 en attente d'une PR autorisée.
